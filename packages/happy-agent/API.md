...
Cloud owns only authentication and organization (team) management.
...
may replace a potentially large full resource.
...
- `config`, `profile`, `onboarding`, `cloud`, and `happyIntegration` — the full
