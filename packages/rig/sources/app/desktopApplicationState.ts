...
export async function desktopApplicationContentHash(
    ...
    await repositoryFilesHash(hash, rigRoot, [
        ...
        "packages/happy-agent-base/package.json",
        "packages/happy-agent-base/sources",
        "packages/happy-agent-features/package.json",
        "packages/happy-agent-features/sources",
