...
export function withRequestContext<Result>(
    ...
    return runSemanticContext(`happy.terminal.api.${route}`, logContext, work);
}
...
export async function withUntracedRequestContext<Result>(
    ...
    return await work(
        withLogContext(rootContext, {
            context: `happy.terminal.api.${route}`,
            ...logContext,
        }),
    );
}
...
export function withWorkerContext<Result>(
    ...
    return runSemanticContext(`happy.terminal.worker.${worker}`, logContext, work);
}
...
export function withConnectionContext<Result>(
    ...
    return runSemanticContext(`happy.terminal.connection.${connection}`, logContext, work);
}
...
export function withProcessContext<Result>(
    ...
    return runSemanticContext(`happy.terminal.process.${processName}`, logContext, work);
}
...
export function withTerminalContext<Result>(
    ...
    return runSemanticContext(`happy.terminal.terminal.${terminal}`, logContext, work);
}
...
export function initializeDaemonContext(
    logger: Logger,
    tracer: OpenTelemetryTracer = trace.getTracer("happy.terminal.daemon"),
): void {
