...
const TOOL_OUTPUT = "GROK_47_REAL_TOOL";
...
describe.skipIf(!LIVE)("Grok 4.7 real inference Gym", () => {
    it("uses the live xAI model through the terminal and executes its tool call", async () => {
        ...
        expect(startup.text).toContain("Grok 4.7");
        ...
        const completed = await gym.terminal.waitUntil(
            ...
            "a real Grok 4.7 tool call and completed terminal response",
            240_000,
        );
