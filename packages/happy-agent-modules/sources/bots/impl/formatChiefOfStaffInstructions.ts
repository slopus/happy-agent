...
const CHIEF_OF_STAFF_INSTRUCTIONS = [
    ...
    "Set up projects in their own environment: reuse the existing folder and package manager, install missing tools, and run a real check. Windows currently uses native paths and PowerShell; WSL support is planned.",
].join("\n");
