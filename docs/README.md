...
| [MCP.md](MCP.md)                                           | How to configure local stdio and remote HTTP MCP servers in `~/Happy/Config/mcp.toml`, reload them online, filter tools, and troubleshoot failed connections.                                                                     |
